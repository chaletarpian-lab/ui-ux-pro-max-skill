...
const slides = [
  ...
  ['slide-00-intro-okapi.html', 'output/arpian-carousel-0-intro-okapi.png'],
  ...
  ['slide-post-adults-kids.html', 'output/arpian-post-adults-kids.png'],
  ['slide-post-okapi-ciel.html', 'output/arpian-post-okapi-ciel.png'],
];
